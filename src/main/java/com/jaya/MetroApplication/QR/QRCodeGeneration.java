package com.jaya.MetroApplication.QR;
...
public class QRCodeGeneration {
    ...
    private static final String strDateFormat = "yyyyMMddhmmss";
    ...
    private void processQRcode(String data, String path, String charset, int height, int width)
         ...
         * subclass for
         * the BarcodeFormat requested and encodes the barcode with the supplied
         * contents.
         */
